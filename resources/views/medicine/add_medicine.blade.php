                ...
                <div class="col-xl-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Here’s a quick example to demonstrate Bootstrap’s form styles.
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Create horizontal forms with the grid by adding the
                                <code>.row</code> class to form groups and using the <code>.col-*-*</code> classes to
                                specify the width of your labels and controls. Be sure to add
                                <code>.col-form-label</code> to your <code>&lt;label&gt;</code>s as well so they’re
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group mb-0 justify-content-end row">
                                    <div class="col-9">
                                        <button type="submit" class="btn btn-info waves-effect waves-light">Sign in
                                        </button>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Each checkbox and radio <code>&lt;input&gt;</code> and <code>&lt;label&gt;</code>
                                pairing is wrapped in a <code>&lt;div&gt;</code> to create our custom control.
                                Structurally, this is the same approach as our default <code>.form-check</code>.</p>
                            ...
                            <!-- Inline-->
                            <h6 class="mt-4">Inline Radios</h6>
                            ...
                            <div class="mt-2">
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="customRadio5">Toggle this custom
                                        radio</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Set heights using classes like <code>.form-control-lg</code>
                                and <code>.form-control-sm</code>.</p>

                            <h6 class="mb-3">Input Sizing</h6>
                            <input class="form-control form-control-lg mb-3" type="text" placeholder=".form-control-lg">
                            <input class="form-control mb-3" type="text" placeholder="Default input">
                            <input class="form-control form-control-sm" type="text" placeholder=".form-control-sm">

                            <h6 class="mt-4 mb-3">Select Sizing</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Be sure to use <code>.col-form-label-sm</code> or <code>.col-form-label-lg</code>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Easily extend form controls by adding text, buttons, or button
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-dark waves-effect waves-light" type="button">Button
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-4">Use the <code>.form-inline</code> class to display a series of
                                labels, form controls, and buttons on a single horizontal row. Form controls within
                                inline forms vary slightly from their default states. Controls only appear inline in
                            ...
                            <!-- Auto-sizing -->
                            <h6 class="mt-4 mb-3">Auto Sizing</h6>
                            <form>
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="custom-control custom-checkbox mb-2">
                                            ...
                                            <label class="custom-control-label" for="autoSizingCheck">Remember
                                                me</label>
                                        </div>
                                    </div>
                                    <div class="col-auto">
