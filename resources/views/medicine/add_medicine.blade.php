                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-subtitle mb-4">Each checkbox and radio <code>&lt;input&gt;</code> and <code>&lt;label&gt;</code> pairing is wrapped in a <code>&lt;div&gt;</code> to create our custom control. Structurally, this is the same approach as our default <code>.form-check</code>.</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-subtitle mb-4">Set heights using classes like <code>.form-control-lg</code> and <code>.form-control-sm</code>.</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-subtitle mb-4">Be sure to use <code>.col-form-label-sm</code> or <code>.col-form-label-lg</code> to your <code>&lt;label&gt;</code>s or <code>&lt;legend&gt;</code>s to correctly follow the size of <code>.form-control-lg</code> and <code>.form-control-sm</code>.</p>
                                <form>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-subtitle mb-4">Easily extend form controls by adding text, buttons, or button groups on either side of textual inputs, custom selects, and custom file inputs</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <button class="btn btn-primary   dropdown-toggle waves-effect waves-light" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <button type="submit" class="btn btn-primary mb-2 waves-effect waves-light">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div> <!-- end card-body-->
