...
<!-- Mirrored from myrathemes.com/scoxe/vertical/charts-google.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Nov 2019 15:56:18 GMT -->
<head>
    <meta charset="utf-8" />
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Google Chart</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">A line chart that is rendered within the browser using SVG or VML. Displays tooltips when hovering over points.</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">An area chart that is rendered within the browser using SVG or VML. Displays tips when hovering over points.</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">Like all Google charts, bar charts display tooltips when the user hovers over the data.</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">An interactive candlestick chart.</p>

                                    <div class="chart" id="candlestick-chart"></div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">A column chart is a vertical bar chart rendered in the browser using SVG or VML, whichever is appropriate for the user's browser.</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">A chart that lets you render each series as a different marker type from the following list: line, area, bars, candlesticks, and stepped area.</p>
                                    
                                    <div class="chart" id="combo-chart"></div>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
                        </div> <!-- end col -->
                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">A pie chart that is rendered within the browser using SVG or VML. Displays tooltips when hovering over slices.</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">If you set the <code>is3D</code> option to <code>true</code>, your pie chart will be drawn as though it has three dimensions:</p>
                                    
                                    <div class="chart" id="piechart-3d-chart"></div>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
                        </div> <!-- end col -->
                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">A donut chart is a pie chart with a hole in the center. You can create donut charts with the pieHole option:</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Exploding a Slice</h4>
                                    <p class="card-subtitle mb-4">You can separate pie slices from the rest of the chart with the offset property of the slices option:</p>
                                    
                                    <div class="chart" id="exploding-slice-chart"></div>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
                        </div> <!-- end col -->
                    </div>
